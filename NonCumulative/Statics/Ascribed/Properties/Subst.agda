...
wk,v0≈I : ∀ {i} →
          ⊢ (T ↙ i) ∷ Γ →
          --------------------------------
          (T ↙ i) ∷ Γ ⊢s wk , v 0 ≈ I ∶ (T ↙ i) ∷ Γ
wk,v0≈I ⊢TΓ@(⊢∷ ⊢Γ ⊢T) = s-≈-sym (s-≈-trans (,-ext (s-I ⊢TΓ)) (,-cong (∘-I (s-wk ⊢TΓ)) ⊢T (≈-conv ([I] (vlookup ⊢TΓ here)) ([]-cong-Se″ ⊢T (s-wk ⊢TΓ) (s-≈-sym (∘-I (s-wk ⊢TΓ)))))))
...
module _ {i} (⊢Γ : ⊢ Γ) (⊢TNΔ : ⊢ (T ↙ i) ∷ N₀ ∷ Δ) (⊢σ : Γ ⊢s σ ∶ Δ) where
  ...
  private
    ...
    ⊢v1′ = ⊢vn∶N L.[ T [ q σ ] ↙ i ] ⊢T[qσ]NΓ refl
  ...
  [wk∘wk]∘q[qσ]≈σ∘[wk∘wk]-TN : (T [ q σ ] ↙ i) ∷ N₀ ∷ Γ ⊢s wk ∘ wk ∘ q (q σ) ≈ σ ∘ (wk ∘ wk) ∶ Δ
  ...
  wk∘wk∘qqσ≈σ∘wk∘[wkwk,suv1] : (T [ q σ ] ↙ i) ∷ N₀ ∷ Γ ⊢s wk ∘ wk ∘ q (q σ) ≈ σ ∘ wk ∘ ((wk ∘ wk) , su (v 1)) ∶ Δ
  ...
  suv1[qqσ]≈v0[wkwk,suv1] : (T [ q σ ] ↙ i) ∷ N₀ ∷ Γ ⊢ su (v 1) [ q (q σ) ] ≈ v 0 [ (wk ∘ wk) , su (v 1) ] ∶[ 0 ] N
  suv1[qqσ]≈v0[wkwk,suv1] =
    ...
    ≈⟨ su-cong (≈-conv-N-[] ([,]-v-ze ⊢σ∘wk∘wk (N-wf ⊢Δ) (conv (t[σ] (conv (⊢vn∶N L.[] ⊢NΓ refl) (≈-sym (N-[] ⊢σ∘wk))) (s-wk ⊢T[qσ]NΓ)) ([∘]-Se (N-wf ⊢Δ) ⊢σ∘wk (s-wk ⊢T[qσ]NΓ)))) ⊢σ∘wk∘wk) ⟩
      su (v 0 [ wk ])
    ≈⟨ su-cong (≈-conv (≈-trans ([wk] ⊢NΓ ⊢T[qσ] here) (≈-sym ([I] (⊢vn∶T[wk]suc[n] {Δ = L.[ T [ q σ ] ↙ i ]} ⊢T[qσ]NΓ refl)))) (N-[][] (s-wk ⊢NΓ) (s-wk ⊢T[qσ]NΓ))) ⟩
      su (v 1 [ I ])
    ≈⟨ su-cong ([I] ⊢v1′) ⟩
      su (v 1)
  ...
  [wkwk,suv1]∘qqσ≈qσ∘[wkwk,suv1] : (T [ q σ ] ↙ i) ∷ N₀ ∷ Γ ⊢s ((wk ∘ wk) , su (v 1)) ∘ q (q σ) ≈ q σ ∘ ((wk ∘ wk) , su (v 1)) ∶ N₀ ∷ Δ
  ...
  rec-β-su-T-swap : (T [ q σ ] ↙ i) ∷ N₀ ∷ Γ ⊢ T [ ((wk ∘ wk) , su (v 1)) ] [ q (q σ) ] ≈ T [ q σ ] [ ((wk ∘ wk) , su (v 1)) ] ∶[ 1 + i ] Se i
