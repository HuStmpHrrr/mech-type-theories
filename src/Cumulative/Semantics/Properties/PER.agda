...
module Cumulative.Semantics.Properties.PER (fext : Extensionality 0ℓ (suc 0ℓ)) where
...
open import Cumulative.Statics.Syntax
...
open import Cumulative.Semantics.Properties.PER.Core fext public
