...
-- This file defines the syntax of Cumulative
module Cumulative.Statics.Syntax where
...
mutual
  ...
  -- Definition of terms in Cumulative
  data Exp : Set where
    -- type constructors
    N     : Typ
    Π     : Typ → Typ → Typ
  ...
  -- Definition of (unified) substitutions in Cumulative
  infixl 3 _∘_
