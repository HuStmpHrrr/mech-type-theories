...
-- induction hypothesis in the fundamental theorems, particularly in Λ-E case.
-- This set of rules only adds to the Concise formulation two premises. This set
...
-- c.f. Cumulative.Soundness.Equiv for the proof.
module Cumulative.Soundness.Typing where

open import Lib

open import Cumulative.Statics.Syntax public
import Cumulative.Statics.Concise as C
