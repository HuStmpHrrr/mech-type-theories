...
module Cumulative.Soundness.Fundamental (fext : Extensionality 0ℓ (suc 0ℓ)) where
...
open import Cumulative.Soundness.Typing as S hiding (⊢_; _⊢_∶_; _⊢s_∶_)
open import Cumulative.Soundness.Equiv
open import Cumulative.Soundness.Contexts fext
open import Cumulative.Soundness.Nat fext
open import Cumulative.Soundness.Pi fext
open import Cumulative.Soundness.Substitutions fext
open import Cumulative.Soundness.Terms fext
open import Cumulative.Soundness.Universe fext
