...
module Cumulative.Completeness.Contexts (fext : Extensionality 0ℓ (suc 0ℓ)) where
...
-- ∷-cong-helper is separately defined to be used in Cumulative.Completeness.Substitutions
∷-cong-helper : ∀ {i} →
                Γ ⊨ T ≈ T′ ∶ Se i →
                (Γ≈Δ : ⊨ Γ ≈ Δ) →
                ρ ≈ ρ′ ∈ ⟦ Γ≈Δ ⟧ρ →
