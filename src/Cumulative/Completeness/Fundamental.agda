...
module Cumulative.Completeness.Fundamental (fext : Extensionality 0ℓ (suc 0ℓ)) where

open import Lib
open import Cumulative.Completeness.Contexts fext
open import Cumulative.Completeness.LogRel
open import Cumulative.Completeness.Nat fext
open import Cumulative.Completeness.Pi fext
open import Cumulative.Completeness.Substitutions fext
