...
module NonCumulative.Ascribed.Consequences (fext : ∀ {ℓ₁ ℓ₂} → Extensionality ℓ₁ ℓ₂) where
...
open import NonCumulative.Ascribed.Completeness fext
...
open import NonCumulative.Ascribed.Soundness fext
