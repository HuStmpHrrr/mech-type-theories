...
module NonCumulative.Ascribed.Completeness.Contexts (fext : Extensionality 0ℓ (suc 0ℓ)) where
...
-- ∷-cong-helper is separately defined to be used in NonCumulative.Ascribed.Completeness.Substitutions
∷-cong-helper : ∀ {i} →
                Γ ⊨ T ≈ T′ ∶[ 1 + i ] Se i →
                (Γ≈Δ : ⊨ Γ ≈ Δ) →
                ρ ≈ ρ′ ∈ ⟦ Γ≈Δ ⟧ρ →
