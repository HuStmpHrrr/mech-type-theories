...
module NonCumulative.Ascribed.Soundness.Fundamental (fext : ∀ {ℓ₁ ℓ₂} → Extensionality ℓ₁ ℓ₂) where
...
open import NonCumulative.Ascribed.Soundness.Contexts fext
open import NonCumulative.Ascribed.Soundness.Nat fext
open import NonCumulative.Ascribed.Soundness.Pi fext
open import NonCumulative.Ascribed.Soundness.Substitutions fext
open import NonCumulative.Ascribed.Soundness.Terms fext
open import NonCumulative.Ascribed.Soundness.Universe fext
