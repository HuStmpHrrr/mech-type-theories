...
⊢r-Tr : ∀ n → Ψ ⊢r σ ∶ Ψ′ → n < len Ψ′ → ∃₂ λ Φ₁ Φ₂ → ∃₂ λ Φ₃ Φ₄ → Ψ′ ≡ Φ₁ ++⁺ Φ₂ × Ψ ≡ Φ₃ ++⁺ Φ₄ × len Φ₁ ≡ n × len Φ₃ ≡ L σ n × Φ₄ ⊢r Tr σ n ∶ Φ₂
...
...     | Φ₃ , Φ₄ , eq , eql , Trσ≈
        rewrite Tr-I (len Φ₁)         = Φ₁ , Φ₂ , Φ₁ , Φ₂
                                      , refl , refl , refl , sym (trans (L-resp-≈ n σ≈I n<) (L-I _))
                                      , helper (++⁺ˡ-cancel Φ₁ Φ₃ eq (sym (trans eql (trans (L-resp-≈′ Φ₁ σ≈I) (L-I (len Φ₁))))))
...
...     | Φ₅ , Φ₆ , eq″ , eql″ , Trσ≈ = [] ∷ Φ₁ , Φ₂ , Γs ++ Φ₃ , Φ₄
                                      ...
                                      , helper (++⁺ˡ-cancel (Γs ++ Φ₃) Φ₅
                                                            (trans (++-++⁺ Γs) eq″)
                                                            (sym (trans eql″
                                                                 (trans eqL
                                                                 (trans (cong (_ +_) (sym eql′))
                                                                        (sym (length-++ Γs)))))))
  where eqL = L-resp-≈ (suc n) σ≈； (s≤s n<)
        helper : Φ₄ ≡ Φ₆ → Φ₄ ⊢r S-Tr σ (suc n) ∶ Φ₂
        helper refl = s≈-resp-⊢r Trσ≈ Trδ

⊢r-Tr′ : ∀ Γs → Ψ ⊢r σ ∶ Γs ++⁺ Ψ′ → ∃₂ λ Φ₁ Φ₂ → Ψ ≡ Φ₁ ++⁺ Φ₂ × len Φ₁ ≡ L σ (len Γs) × Φ₂ ⊢r Tr σ (len Γs) ∶ Ψ′
⊢r-Tr′ Γs ⊢σ
  with ⊢r-Tr (len Γs) ⊢σ (length-<-++⁺ Γs)
...  | Φ₁ , Φ₂ , Φ₃ , Φ₄
     , eq , eq′ , eql , eql′ , Trδ
     rewrite ++⁺ˡ-cancel Γs Φ₁ eq (sym eql) = Φ₃ , Φ₄ , eq′ , eql′ , Trδ
